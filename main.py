...
>>>>>>> 1c0d82a359fe7a11c8a4494d09550bf1e7ff771a
...
=======
		...
		with nidaqmx.task.Task() as task:
			...
			task.timing.cfg_samp_clk_timing(1e6)
			stream = nidaqmx._task_modules.out_stream.OutStream(task)
			writer = AnalogSingleChannelWriter(stream)
